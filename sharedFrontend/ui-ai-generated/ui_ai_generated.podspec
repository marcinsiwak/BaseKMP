Pod::Spec.new do |spec|
    ...
    spec.vendored_frameworks      = 'build/cocoapods/framework/ui_ai_generated.framework'
    spec.libraries                = 'c++'
    spec.ios.deployment_target    = '16.2'
                
                
    if !Dir.exist?('build/cocoapods/framework/ui_ai_generated.framework') || Dir.empty?('build/cocoapods/framework/ui_ai_generated.framework')
        raise "
