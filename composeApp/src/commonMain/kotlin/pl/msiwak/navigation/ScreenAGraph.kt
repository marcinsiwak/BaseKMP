...
import basekmp.shared_frontend.common_resources.generated.resources.compose_multiplatform
            ...
            composable<NavDestination.ScreenADestination.Screen> {
                Column {
                    ...
                    Column(Modifier.fillMaxWidth(), horizontalAlignment = Alignment.CenterHorizontally) {
                        ...
                        Button(onClick = {
                            navController.navigate(NavDestination.CreatePredictionDestination.Screen)
                        }) {
